...
def get_unit_and_ship_df(ally_code_list, account_names):
    ...
    for i in range(len(account_names)):
        ...
        print(f'{account_names[i]} scanned! {i+1}/{len(account_names)}')
    # Convert dictionary to DataFrame
...
def main():
    print('Welcome to SWGoH Holotable Harvester!\n')
    ...
    print(f'Collecting information of {guild_name}...\n')
    ...
    print('Remember, you can find the reports in the output folder.')
    # Get Account Data
    ...
    """# Create Files"""
    print('Please wait while the reports are being generated...')
    ...
    sleep(1)
    print('We hope the reports are helpful! Come back soon!')
    sleep(1)
    input('[ENTER] to exit...')
